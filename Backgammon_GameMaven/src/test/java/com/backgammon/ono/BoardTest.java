...
class BoardTest {
    ...
    void testConstructor() {
            ...
            assertEquals(2, board.getPip(1).size() + board.getPip(24).size(), "Initial pip setup should be correct");
    ...
    @Test
    void movePiptoPip() {
        board.addCheckertoPip(1, new Checker("X"));
        board.movePiptoPip(1, 2);
        assertTrue(board.getPip(1).isEmpty(), "Pip 1 should be empty after the move");
        assertFalse(board.getPip(2).isEmpty(), "Pip 2 should contain a checker after the move");
